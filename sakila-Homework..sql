...
ALTER TABLE actor 
CHANGE 
COLUMN middle_name middle_name
 BLOB NULL DEFAULT NULL ;

/***4a. List the last names of actors, as well as how many actors have that last name.
SELECT 
DISTINCT last_name, COUNT(last_name) AS 'name_count'
	FROM
    actor
GROUP BY last_name;
...
/***8c. You find that you no longer need the view top_five_genres. Write a query to delete it.---1b. Display the FIRST AND LAST NAME of EACH actor IN a single COLUMN IN UPPER CASE letters. NAME the COLUMN Actor Name.
